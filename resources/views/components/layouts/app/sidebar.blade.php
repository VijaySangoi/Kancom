    ...
    <div class="h-full flex flex-col">
        ...
        <nav class="flex-1 overflow-y-auto custom-scrollbar py-4">
            <ul class="space-y-1 px-2">
                ...
                <!-- Example two level -->
                <x-layouts.sidebar-two-level-link-parent title="Products" icon="fas-house" :active="request()->routeIs('two-level*')">
                    <x-layouts.sidebar-two-level-link href="{{ route('import') }}" icon='fas-house' :active="request()->routeIs('two-level*')">
                        Import
                    </x-layouts.sidebar-two-level-link>
                    <x-layouts.sidebar-two-level-link href="view" icon='fas-house' :active="request()->routeIs('two-level*')">
                        View
                    </x-layouts.sidebar-two-level-link>
                ...
                <x-layouts.sidebar-link href="{{ route('scrathpad') }}" icon='fas-house' :active="request()->routeIs('scrathpad*')">
                    Scarthpad
                </x-layouts.sidebar-link>
            </ul>
        </nav>
